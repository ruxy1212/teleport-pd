        ...
        <>
            <nav className="flex fixed top-0 left-0 w-full z-30 justify-between items-center self-stretch py-2 px-6 bg-pd-white max-w-[1200px] mx-auto">
                ...
                <div className="flex items-center gap-2 py-2 md:hidden">
                    <button className="flex w-12 h-12 justify-center items-center" onClick={()=>setOpen(true)} >
                        <img src={Menu} alt="" />
                    </button>
                    {/* <button className="py-4 px-9 flex items-center gap-2 bg-pd-black text-pd-white rounded-[3.25rem] font-medium pd-button font-montserrat">Go To Cart<ArrowRight className="h-5 w-5"/></button>
                     flex
            ...
            <div className={`${open?'flex':'hidden'} md:hidden fixed top-0 left-0 w-screen h-screen z-40 bg-pd-black/50 justify-end`}>
                <nav className="relative right-0 w-[80%] w-max-[300px] z-40 bg-pd-white rounded-s-3xl py-2 px-6" onBlur={()=>setOpen(false)}>
                    <div className="flex justify-end py-2">
                        <button className="flex w-12 h-12 justify-center items-center" onClick={()=>setOpen(false)}>
                            <img src={Close} alt="" />
                        </button>
                    </div>
