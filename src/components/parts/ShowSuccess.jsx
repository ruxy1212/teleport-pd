...
export default function ShowSuccess() {
  return (
    <div className="flex flex-col justify-between items-center">
        <img loading="lazy" src={tick} className="mt-14 w-40 max-w-full aspect-square"/>
        <h3 className="mt-16 pd-h3 leading-8 text-center text-pd-black">Your Order is confirmed!</h3>
