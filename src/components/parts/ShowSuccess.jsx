...
export default function ShowSuccess() {
  return (
    <div className="flex flex-col justify-between items-center">
        ...
        ships.</p>
        <Link to="/" className="mt-10 mb-5 py-4 px-10 flex items-center justify-center gap-2 bg-pd-red text-pd-white rounded-[3.25rem] font-medium pd-button font-montserrat">Continue Shopping</Link>
    </div>
  );
}
